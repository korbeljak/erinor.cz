...
<br>
<form action="" method="post" class="prepocitavadlo dulezite">
...
{
   if ((int)$_POST["mesic"] > 12 || (int)$_POST["mesic"] < 1)
   {
       $chyba = "Neexistující reálný měsíc.";
   }
   elseif ((int)$_POST["den"]>31 || (int)$_POST["den"]<1)
   {
       $chyba = "Neexistující reálný den.";
   }
   else
   {
       $a = lithen_date(DateTime::createFromFormat("Y-m-d", $_POST["rok"]."-".$_POST["mesic"]."-".$_POST["den"]));
       echo "<strong class=\"red\">Erinorské datum (".$_POST["rok"]."-".$_POST["mesic"]."-".$_POST["den"]."): ".$a."</strong><br><br>";
   }
